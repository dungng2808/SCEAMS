...
builder.Services.AddHttpClient<
    ...
    .AddHttpMessageHandler<BearerTokenHandler>();
builder.Services.AddHttpClient<
    IEventReminderApiClient,
    EventReminderApiClient>(
    (serviceProvider, client) =>
    {
        var settings = serviceProvider
            .GetRequiredService<IOptions<ApiSettings>>()
...
builder.Services.AddHttpClient<IEventApiClient, EventApiClient>(
    ...
    .AddHttpMessageHandler<BearerTokenHandler>();
builder.Services.AddHttpClient<IRegistrationApiClient, RegistrationApiClient>(
    (serviceProvider, client) =>
    {
        var settings = serviceProvider
            .GetRequiredService<IOptions<ApiSettings>>()
    ...
    .AddHttpMessageHandler<BearerTokenHandler>();
builder.Services.AddHttpClient<IEventRegistrationApiClient, EventRegistrationApiClient>(
    (serviceProvider, client) =>
    {
        var settings = serviceProvider
            .GetRequiredService<IOptions<ApiSettings>>()
